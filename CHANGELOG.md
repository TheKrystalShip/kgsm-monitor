...
### Fixed — the packaged binary is executable again (2.20.2)
...
### Fixed — the descriptor names this leaf's unit, not a path to it (2.20.1)

The `systemd-unit` floor source names `kgsm-monitor.service`. Where that file sits is a property of how the host was
