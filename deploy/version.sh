...
#
# The version is declared in exactly ONE place — src/Monitor/Monitor.csproj — and read from there, so the package,
# the binary and the changelog can never disagree about what this is.
#
# The DAEMON's version. Monitor.Contracts is a separately-published NuGet and versions on its own
# schedule — it is not what this package ships.
...
SOURCE_FILE="${HERE}/../src/Monitor/Monitor.csproj"
